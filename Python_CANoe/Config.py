...
class CanoeSync(object):
    ...
    def __init__(self):
        ...
        # self.Namespaces=systemCAN.Namespaces
    ...
    def LoadVariables(self):
        self.Namespaces=self.System.Namespaces
        # print(self.Configuration.FullName)
        # print(self.System.Namespaces.Item)
        # self.Namespaces.Item("LIN")
        # self.Namespaces.GetIDsOfNames('test_001')
        for item_Namespaces in self.Namespaces:
            print(item_Namespaces.Name)
        
        item_lin = self.Namespaces.Item("LIN")
        for item in item_lin.Variables:
            print(item.Name)
        # print(dir(item_lin))
        # for item in item_lin:
        #     print(item.Name)
        # for item in self.Namespaces.Item("LIN"):
        #     print(item.Name)
        #     print(dir(item))
        #     print(item.Variables('test001'))
            # print(item.Variables)
            # print(__doc__(item))
            # print(item.Variables)
            # print(item.Name)
            # print(item.Item.Name)
            # print(item.QueryInterface)
            
            # print(dir(item))
        # self.Namespaces = self.System.Namespaces
        # Var_Test_00=self.Namespaces
        # Var_Test_00=self.Namespaces.Application
        # Var_Test_00=self.Namespaces.Add("Var_Test_00")
        # Var_Test_00_01=Var_Test_00.Variables
        # Application
        # for i in range(1,self.Namespaces.Count):
        #     print(self.Namespaces.Item)#     
