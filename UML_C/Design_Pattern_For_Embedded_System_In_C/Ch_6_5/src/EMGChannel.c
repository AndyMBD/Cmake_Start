...
return me->itsCalculateColor.red<<16 + me->itsCalculateColor.green<<8 + me->itsCalculateColor.
blue;
}
...
struct EMGSensorDeviceDriver* EMGChannel_getItsEMGSensorDeviceDriver(const EMGChannel*
const me) {
